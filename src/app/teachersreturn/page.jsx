...
export default function Teachersreturn() {
  ...
  return (
    <div className="container-fluid">
          ...
          <table style={{ border: "1px solid", width: "100%" }}>
            <thead>
              <tr style={{ border: "1px solid" }}>
                <th rowSpan={3} style={{ border: "1px solid" }}>
                  Sl. No.
                </th>
                <th rowSpan={3} style={{ border: "1px solid" }}>
                  Name of Teacher
              ...
              <tr style={{ border: "1px solid" }}>
                <th style={{ border: "1px solid" }}>Full Pay</th>
                <th style={{ border: "1px solid" }}>Half Pay</th>
                <th style={{ border: "1px solid" }}>Without Pay</th>
              </tr>
            </thead>
            <tbody>
              {/* Teachers data */}
      ...
      <div className="mx-auto my-5 nobreak p-2" style={{ border: "2px solid" }}>
        <h4 className="dejavu fs-5">PART- 'B': PARTICULARS OF STUDENTS</h4>
        <div className="mx-auto" style={{ border: "1px solid", width: "100%" }}>
          <table style={{ border: "1px solid", width: "100%" }}>
            <thead>
              <tr style={{ border: "1px solid" }}>
                <th colSpan={2} style={{ border: "1px solid" }}>
                ...
                <th style={{ border: "1px solid" }}>Class-I</th>
                <th style={{ border: "1px solid" }}>Class-II</th>
                <th style={{ border: "1px solid" }}>Class-III</th>
                <th style={{ border: "1px solid" }}>Class-IV</th>
                <th style={{ border: "1px solid" }}>Class-V</th>
        ...
        <div className="mx-auto" style={{ border: "1px solid", width: "100%" }}>
          ...
          <div className="my-2 d-flex justify-content-evenly align-items-center">
            <h4 className="fw-bold">Countersigned</h4>
