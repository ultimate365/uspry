      ...
      <Page size="A4" orientation="landscape" style={styles.page}>
        <View style={styles.pageMainView}>
          ...
          <View style={styles.tableStartView}>
            ...
            <View style={styles.view25}>
              <Text style={styles.text}>Ward No.:- {WARD_NO}</Text>
            </View>
            <View
              style={{
                borderTopWidth: 0,
            ...
            >
              <Text style={styles.text}>Municipality/ Corporation (HMC)</Text>
            </View>
          </View>
          ...
          <View style={styles.rowStartView}>
            <View style={styles.view25}>
              <Text style={styles.text}>Basic Information of School:-</Text>
            </View>
            <View
              style={{
                borderTopWidth: 0,
            ...
            >
              <Text style={styles.text}>{SCHOOL_TYPE}</Text>
            </View>
          ...
          <View style={styles.rowStartView}>
            ...
            <View style={styles.view125}>
              <Text style={styles.text}>{prevMonthlyData?.ricePryRC} KG.</Text>
            </View>
            <View style={styles.view125}>
            ...
            <View style={styles.view125}>
              <Text style={styles.text}>{prevMonthlyData?.ricePryEX} KG.</Text>
            </View>
            <View style={styles.view125}>
      ...
      <Page size="A4" style={styles.page} orientation="landscape">
        <View style={styles.pageMainView}>
          ...
          <View style={styles.rowStartView}>
            ...
            <View style={[styles.view88H20, { width: "8.8%" }]}>
              <Text style={styles.text}>{prevMonthlyData?.ricePryOB} KG.</Text>
            </View>
            <View style={[styles.view88H20, { width: "12%" }]}>
              <Text style={styles.text}>{prevMonthlyData?.ricePryRC} KG.</Text>
            </View>
