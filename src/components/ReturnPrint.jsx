      ...
      >
        <Page size="A4" orientation="landscape" style={styles.page}>
          <View style={styles.pageMainView}>
            ...
            <View
              style={[styles.rowFlexView, { justifyContent: "flex-start" }]}
            >
              <View style={styles.rowFlexView}>
                  ...
                  <View style={[styles.view5, { width: "18%" }]}>
                    <View
                      style={{
                        ...
                        justifyContent: "center",
                        alignItems: "center",
                        alignContent: "center",paddingBottom:5
                      }}
                    >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <Text style={[styles.text,{fontSize:9}]}>Without Pay</Text>
                          </View>
                        </View>
                      </View>
                    </View>
                    ...
                    return (
                      <React.Fragment key={index}>
                        <View style={styles.rowStartView}>
                          ...
                          <View
                            style={[styles.view5H0, { borderRightWidth: 0 }]}
                          >
                            <Text style={styles.text}></Text>
                          </View>
                        </View>
